...
public interface UserRepository extends JpaRepository<User, Long>{	
	...
	//JPARepository icerisinde custom query ile dml operation yaziliyorsa updating annotasyonu koyulmali
	//Bu Updateden daha iyisi var direk yeni degerleri usera set edip reponun save methoduyla ustune yazmak
	@Modifying
